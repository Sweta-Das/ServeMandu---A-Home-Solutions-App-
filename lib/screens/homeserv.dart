                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage("assets/hs (${index + 1}).png"),
                              fit: BoxFit.cover,
                              opacity: 0.8,
                            ),
                          ),
...
class PostScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage("https://images.unsplash.com/photo-1607729715312-5ace53575064?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80"),
          fit: BoxFit.cover,
          opacity: 0.5,
        ),
      ),
