...
class IT_Support extends StatelessWidget {
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: AssetImage("assets/it (${index + 1}).png"),
                              fit: BoxFit.cover,
                              opacity: 0.8,
                            ),
                          ),
...
class PostScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
          image: NetworkImage("https://img.freepik.com/free-photo/rpa-concept-with-blurry-hand-touching-screen_23-2149311914.jpg?size=626&ext=jpg"),
          fit: BoxFit.cover,
          opacity: 0.5,
        ),
      ),
